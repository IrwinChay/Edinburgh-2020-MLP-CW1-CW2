...
class Optimiser(object):
    ...
    def __init__(self, model, error, learning_rule, train_dataset,
                 ...
                 notebook=False, test_dataset=None):
    ...
    def get_test_stats(self):
        ...
        if self.test_dataset is not None:
            test_stats.update(self.eval_monitors(
    ...
    def train(self, num_epochs, stats_interval=5):
        ...
        # get testing stats at the end of the training
        test_stats = self.get_test_stats()
        
        return np.array(run_stats), {k: i for i, k in enumerate(stats.keys())}, total_train_time, test_stats, self.model

    def test(self, test_dataset):
        """Returns testing results for specified dataset
