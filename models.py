...
class MultipleLayerModel(object):
    ...
    def load_model_from_txt(file_name):
        """ 
        Loads model parameters from a txt file
        
        Args: name of the txt file to load parameters from
        Parameters format: 
        list of alternating arrays; first array for weights, second for biases
        these "tuples" (not from a programming perspective) length is equal to the number of layers of the model
        """
